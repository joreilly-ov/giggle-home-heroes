...
const About = () => (
  <div className="min-h-screen flex flex-col page-bg">
    ...
    <main className="flex-1 max-w-3xl mx-auto px-4 py-20">
      ...
      <p className="text-muted-foreground mb-4">KisXCars was founded with a simple mission: make it ridiculously easy for homeowners to find trustworthy contractors — and for contractors to find steady, well-paying work.</p>
